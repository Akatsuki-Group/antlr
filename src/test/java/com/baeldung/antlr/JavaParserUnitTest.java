...
public class JavaParserUnitTest {
    ...
    public void whenOneMethodStartsWithUpperCase_thenOneErrorReturned() throws Exception{
        ...
        com.baeldung.antlr.Java8Lexer java8Lexer = new com.baeldung.antlr.Java8Lexer(CharStreams.fromString(javaClassContent));
        CommonTokenStream tokens = new CommonTokenStream(java8Lexer);
        com.baeldung.antlr.Java8Parser java8Parser = new com.baeldung.antlr.Java8Parser(tokens);
