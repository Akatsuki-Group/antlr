...
public class LogParserUnitTest {
    ...
    public void whenLogContainsOneErrorLogEntry_thenOneErrorIsReturned() throws Exception {
        ...
        com.baeldung.antlr.LogLexer serverLogLexer = new com.baeldung.antlr.LogLexer(CharStreams.fromString(logLines));
        CommonTokenStream tokens = new CommonTokenStream( serverLogLexer );
        com.baeldung.antlr.LogParser logParser = new com.baeldung.antlr.LogParser(tokens);
